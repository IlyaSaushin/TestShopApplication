...
import com.earl.shop_presentation.databinding.RecyclerProdColorItemBinding
import com.earl.shop_presentation.databinding.RecyclerProdColorSelectedItemBinding
        ...
        when(viewType) {
            SELECTED -> {
                BaseProductColorViewHolder.SelectedColor(
                    RecyclerProdColorSelectedItemBinding.inflate(LayoutInflater.from(parent.context),
                        parent,
                        false)
                )
            }
            NOT_SELECTED -> {
                BaseProductColorViewHolder.NotSelectedColor(
                    RecyclerProdColorItemBinding.inflate(LayoutInflater.from(parent.context),
                    parent,
                    false)
                )
            }
