package com.earl.shop_presentation.ui.productDetails.recyclerAdapters
...
import com.earl.shop_presentation.databinding.RecyclerProductImagePreviewBinding
import com.earl.shop_presentation.databinding.RecyclerProductImagePreviewSelectedBinding
        ...
        return when(viewType) {
            SELECTED -> {
                BaseProductImagePreviewViewHolder.SelectedImage(
                    RecyclerProductImagePreviewSelectedBinding.inflate(LayoutInflater.from(parent.context),
                        parent,
                        false
                    )
                )
            ...
            NOT_SELECTED -> {
                BaseProductImagePreviewViewHolder.NotSelectedImage(
                    RecyclerProductImagePreviewBinding.inflate(LayoutInflater.from(parent.context),
                        parent,
                        false
                    )
                )
