...
import com.earl.shop_feature.databinding.RecyclerFlashSaleItemBinding
...
class FlashSaleProductsRecyclerAdapter(
    ...
    companion object Diff : DiffUtil.ItemCallback<FlashSaleProductUi>() {
        override fun areItemsTheSame(oldItem: FlashSaleProductUi, newItem: FlashSaleProductUi) =
            oldItem.same(newItem)
        override fun areContentsTheSame(oldItem: FlashSaleProductUi, newItem: FlashSaleProductUi) =
