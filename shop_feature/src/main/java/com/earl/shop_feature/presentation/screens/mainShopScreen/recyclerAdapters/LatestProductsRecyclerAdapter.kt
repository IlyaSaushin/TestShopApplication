...
import com.earl.shop_feature.databinding.RecyclerLatestItemBinding
...
class LatestProductsRecyclerAdapter : BaseRecyclerAdapter<LatestProductUi, BaseRecyclerViewHolder<LatestProductUi>>(
    Diff
) {
    ...
    companion object Diff : DiffUtil.ItemCallback<LatestProductUi>() {
        override fun areItemsTheSame(oldItem: LatestProductUi, newItem: LatestProductUi) =
            oldItem.same(newItem)
        override fun areContentsTheSame(oldItem: LatestProductUi, newItem: LatestProductUi) =
